...
1) from  p1  . mod1  import  *
    Can  members  of  mod1  be  used ?  ---> 	Yes  with  member
...
2) import  p1
    ...
    from  p1  import  mod1
    from  p1 . mod1  import  *
    Which  statement  permits  to  use  members  of  __init__ module ?  --->  Only  first  two  statements
'''